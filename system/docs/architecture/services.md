...
**application.ChangeMonitoringSystem** registers bot and tracker instances, tracks leases and routes network requests.
...
New services are started as separate Docker containers or Kubernetes workloads and register without restarting application.ChangeMonitoringSystem.
