...
**SubscriptionService** owns subscriptions, registers bots and trackers, tracks their confirmed availability and routes network requests.
...
New services are started as separate Docker containers or Kubernetes workloads and register without restarting SubscriptionService.
